package com.idat.Tarea.seguridad;
...
import com.idat.Tarea.repositorio.UsuarioRepositorio;
...
public class UserDetailService implements UserDetailsService {
	...
	public UserDetails loadUserByUsername(String username) throws UsernameNotFoundException {
		...
		if(usuario != null) {
			...
			GrantedAuthority authority = new SimpleGrantedAuthority(usuario.getCargo());
